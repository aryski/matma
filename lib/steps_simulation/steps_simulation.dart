...
class StepsSimulation extends StatelessWidget {
  const StepsSimulation({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    final bloc = StepsSimulationBloc(simSize, eqCubit, taskCubit);
...
class StepsSimulatorContent extends StatelessWidget {
  ...
  final StepsGameData data;
  final StepsSimulationBloc bloc;
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          RawStepsSimulation(
              unitRatio: unitRatio, horizUnitRatio: horizUnitRatio),
...
class RawStepsSimulationExample extends StatelessWidget {
  const RawStepsSimulationExample(
...
class RawStepsSimulation extends StatelessWidget {
  const RawStepsSimulation({
    super.key,
    required this.unitRatio,
    required this.horizUnitRatio,
  });
